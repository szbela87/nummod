...
**(b)** Adja meg az $x = 5.5$ szám gépi ábrázolását ($\operatorname{fl}(x)$) ebben a rendszerben! Írja fel a normalizált alakot: $\operatorname{fl}(x) = \pm m \cdot 2^k$.
...
$$
\operatorname{fl}(5.5) = +\, 0.1011_2 \cdot 2^3
$$
...
$$
\| A \|_F = \sqrt{1^2 + (-2)^2 + 0^2 + 3^2 + 1^2 + (-1)^2 + 0^2 + 2^2 + 4^2} = \sqrt{1 + 4 + 0 + 9 + 1 + 1 + 0 + 4 + 16} = \sqrt{36} = 6
$$
...
$$
\| A \|_2 = \sqrt{\max \lambda_i(A^T A)} = \sqrt{9} = 3
$$

**(c)**

Igen, $\| A \|_2 = \rho(A) = 3$. Ez mindig teljesül **szimmetrikus** (általánosabban: normális) mátrixra, mert ilyenkor $A^T A$ sajátértékei éppen $\lambda_i^2$, és $\| A \|_2 = \sqrt{\max \lambda_i^2} = \max |\lambda_i| = \rho(A)$.
