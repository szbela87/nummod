...
$$\|Qx\|_2^2=(Qx)^*(Qx)=x^*(Q^*Q)x=x^*Ix=\|x\|_2^2.$$
...
$$(Ax)_i=r_i^T x, \qquad \|Ax\|_2^2=\sum_{i=1}^n (r_i^Tx)^2.$$

Cauchy–Schwarz szerint $|r_i^Tx|\le \|r_i\|_2\|x\|_2$, így

$$\|Ax\|_2^2=\sum_i |r_i^Tx|^2 \le \sum_i \big(\|r_i\|_2^2\|x\|_2^2\big) =\|x\|_2^2\sum_i \|r_i\|_2^2.$$
